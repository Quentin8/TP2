/****************************************************************************
** Meta object code from reading C++ file 'SQLClientWindow.h'
**
...
#error "The header file 'SQLClientWindow.h' doesn't include <QObject>."
...
const QMetaObject SQLClientWindow::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_SQLClientWindow.data,
      qt_meta_data_SQLClientWindow,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *SQLClientWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SQLClientWindow.stringdata0))
        return static_cast<void*>(const_cast< SQLClientWindow*>(this));
